  ...
  return (
    <div className="min-h-screen bg-parchment pb-20 pt-safe">
      <div className="px-5 pt-4">
        ...
        <h1 className="font-serif text-2xl text-ink mt-2">Economy</h1>
        <p className="text-[12px] text-muted italic">Pool balance: ${pool ? (pool.balance_cents / 100).toLocaleString() : 0}</p>
      </div>
      <EconomyForm config={cfg} />
    </div>
  );
}
